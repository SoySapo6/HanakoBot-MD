...
╰────✦ MaycolAPI* ✦────╯`,
    quoted: msg
            ...
            // Agregar el nuevo número a la lista de owners
            const fs = require('fs');
            ...
            if (!configContent.includes(cleanNumber)) {
              // Buscar el array de owners
              const ownerMatch = configContent.match(/global\.owner\s*=\s*\[([\s\S]*?)\];/);
              if (ownerMatch) {
                const ownerList = ownerMatch[1];
                // Agregar el nuevo número al inicio del array
                const newOwnerList = `    ["${cleanNumber}"],\n${ownerList}`;
                configContent = configContent.replace(ownerList, newOwnerList);
                fs.writeFileSync(configPath, configContent);
                console.log(`✅ Número ${cleanNumber} agregado como owner`);
              }
            }
...
case 'menu': {
  try {
    ...
    // Array de imágenes fijas
    const menuImage = 'https://i.postimg.cc/dtpSX0Rk/file-0000000044dc5230a9dbca220f4af1e6-conversation-id-67f0d88c-b6dc-8013-a642-11512f1767d8-message-i.png';
    // Seleccionar una imagen aleatoria del array
    // Using fixed Hanako-kun image
...
⎔ ${global.prefix}antiarabe
⎔ ${global.prefix}antilink
⎔ ${global.prefix}apk
⎔ ${global.prefix}autoadmin
⎔ ${global.prefix}autoadmins
⎔ ${global.prefix}bal
⎔ ${global.prefix}batallaanime
⎔ ${global.prefix}batallamascota
⎔ ${global.prefix}batallauser
...
⎔ ${global.prefix}close
⎔ ${global.prefix}cofre
⎔ ${global.prefix}comando
⎔ ${global.prefix}compra
⎔ ${global.prefix}comprar
⎔ ${global.prefix}comprar2
⎔ ${global.prefix}copiarpg
...
⎔ ${global.prefix}deletemascota
⎔ ${global.prefix}deleteper
⎔ ${global.prefix}deleterpg
⎔ ${global.prefix}deleteuser
⎔ ${global.prefix}dep
⎔ ${global.prefix}depositar
⎔ ${global.prefix}enemigos
⎔ ${global.prefix}entrenar
⎔ ${global.prefix}facebook
⎔ ${global.prefix}fb
⎔ ${global.prefix}ff
⎔ ${global.prefix}ff2
⎔ ${global.prefix}g
⎔ ${global.prefix}gemini
⎔ ${global.prefix}geminis
⎔ ${global.prefix}get
⎔ ${global.prefix}gifvideo
⎔ ${global.prefix}git
⎔ ${global.prefix}gomascota
⎔ ${global.prefix}goper
⎔ ${global.prefix}gouser
⎔ ${global.prefix}gremio
⎔ ${global.prefix}guar
⎔ ${global.prefix}hd
⎔ ${global.prefix}help
⎔ ${global.prefix}hosp
...
⎔ ${global.prefix}volar
⎔ ${global.prefix}welcome
⎔ ${global.prefix}whatmusic
⎔ ${global.prefix}whatmusic2
⎔ ${global.prefix}whatmusic6
⎔ ${global.prefix}work
⎔ ${global.prefix}ytmp3
⎔ ${global.prefix}ytmp35
⎔ ${global.prefix}ytmp4
⎔ ${global.prefix}ytmp45
⎔ ${global.prefix}yts
⎔ ${global.prefix}ytsearch
...
╭─────────────────╮  
✦ HanakoBot-MD Está en
Desarrollo. Se Paciente
╰─────────────────╯  
